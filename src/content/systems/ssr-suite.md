...
tagline: "把横跨几十个团队、持续数月的新人培养，从群消息和表格，推进到能自助报名、能实时互动，还有一个常驻学员群、随时答疑、能进会议、会沉淀数据的 AI 班班。"
...
pipeline: ["一线访谈定位", "报名组队与学习广场", "实时星图大屏", "AI 班班答疑", "入会与流程自动化", "数据自动沉淀"]
media:
  - type: image
    src: /systems/ssr-suite/star-map.jpg
    caption: "实时班级星图：学员手机开卡后一两秒内同步到现场大屏（演示数据已匿名化）"
  - type: image
